...
from ai_recommendation_check import check_payload
...
def test_ai_recommendation_check_accepts_readable_copy():
    payload = {
        "title": "Chisel Tip Highlighter Pens for Students, Office Notes and Journaling, Assorted Colors",
        "bullets": [
            "Color-Code Notes With Less Effort: Designed for students and office users, these highlighter pens help organize textbooks, planners, reports and study pages with clear assorted colors.",
            "Chisel Tip Control: The angled tip supports broad highlighting and fine underlining, making it easier to switch between headings, key terms and margin notes.",
            "Smooth Daily Use: Built for school, office and journaling routines, the markers are easy to keep in a desk drawer, backpack or shared supply area.",
            "Useful Across Study and Work: Use them for exam prep, meeting notes, calendars, Bible study, bullet journals and color-coded project planning.",
            "Ready for Common Highlighting Tasks: The assorted set gives buyers practical colors for everyday reading, planning and review without overcomplicating the workspace.",
        ],
        "description": "These chisel tip highlighter pens are made for students, office users and journal keepers who need a simple way to mark important information. The assorted colors support school notes, work documents, planning pages and daily organization.",
        "backendSearchTerms": "highlighter pens chisel tip markers school office journaling color coding study notes",
        "productBrief": {
            "product": "highlighter pens",
            "productType": "highlighter pens",
            "features": ["chisel tip", "assorted colors"],
            "audience": "students and office users",
            "scenarios": ["school", "office", "journaling"],
        },
        "aiShoppingQuestions": [
            "What highlighters are good for school and office notes?",
            "Do these highlighters work for journaling?",
            "Are these pens useful for color coding study notes?",
            "Who are these highlighter pens for?",
        ],
        "recommendationTriggers": [
            "highlighter pens for students",
            "office color coding",
...
def test_ai_recommendation_check_rejects_ai_ranking_promises():
    payload = {
        "title": "Rufus Optimized AI Recommended Highlighter Pens",
        "bullets": [
            "Best Choice: Premium quality pens with guaranteed ranking for students.",
            "Easy Use: Works for notes.",
            "Office Ready: Works for reports.",
            "Study Ready: Works for school.",
            "Gift Ready: Works for everyone.",
        ],
        "description": "Guaranteed citation and visibility in AI shopping results.",
        "backendSearchTerms": "highlighters",
        "aiShoppingQuestions": ["Who are these for?"],
        "recommendationTriggers": ["highlighter pens for students"],
    }
    result = check_payload(payload)
    warning_types = {warning["type"] for warning in result["warnings"]}
    assert "ai_promise_language" in warning_types
